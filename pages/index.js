...
export default function Home({ language, Theme }) {
  return (
    <>
      {/* <Head>
        <title>
          Frontend webutvikling og webdesign service | Villo Utvikling
        </title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="webdesign, webutvikling, nettside, SEO, frontend-utvikling, frontend-utvikler, frilans, frilanser, frilans utvikler, webutvikler, UI/UX, HTML, CSS, JavaScript, responsivt design, kryssnettleserkompatibilitet"
        />
        <meta name="theme-color" content="#a2cbcc" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://www.jvwebconsult.no/" />
        <meta name="author" content="Villo Utvikling" />
        <meta charSet="UTF-8" />

        <meta
          name="og:title"
          content="Profesjonell Frontend webutvikling og webdesign service | Villo Utvikling"
        />
        <meta
          name="og:description"
        ...
        <meta
          name="twitter:image"
          content="/logo/WindLogoNoTextLightMode.svg"
        />
