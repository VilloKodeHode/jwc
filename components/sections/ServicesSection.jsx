      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mt-10 ">
          <div className="md:grid md:grid-cols-2 md:gap-6">
            ...
            <ServicesSectionPart Theme={Theme}
              language={language}
            ...
            <ServicesSectionPart
              ...
              norTitle="Småjobber"
              engTitle="Odd jobs"
              norText="Hvis du trenger hjelp med noe som ikke er nevnt her, ikke nøl med å ta kontakt med meg. Jeg er alltid åpen for nye utfordringer, og jeg er sikker på at vi kan finne en løsning."
