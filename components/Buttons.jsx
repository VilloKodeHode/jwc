...
export function ScrollToTopButton({Theme}) {
  ...
  return (
    <button
      onClick={scrollToTop}
      className={`${Theme === "light" ? "text-Villo-light-white20 hover:text-Villo-light-secondary" : "text-Villo-dark-black50 hover:text-Villo-dark-secondary" } z-50 p-1 fixed md:bottom-8 bottom-4 md:right-8 right-4 transition-all duration-200 rounded-full hover:scale-125  ${
