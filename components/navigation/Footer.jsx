          ...
          <div className="flex flex-col items-center justify-center">
            <div className="flex flex-row">
              <div className="flex flex-row items-center justify-center m-4">
                <Link href="/contact">
                  <FiMail className="w-8 h-8 mr-4 text-white duration-200 hover:text-Villo-primary hover:scale-125" />
                </Link>
              </div>
              <div className="flex flex-row items-center justify-center m-4">
                <a href="https://github.com/VilloKodeHode" target="_blank">
                  <VscGithubAlt className="w-8 h-8 mr-4 text-white duration-200 hover:text-Villo-primary hover:scale-125" />
                </a>
              </div>
              <div className="flex flex-row items-center justify-center m-4">
                <a
                  ...
                  target="_blank"
                >
                  <SlSocialLinkedin className="w-8 h-8 mr-4 text-white duration-200 hover:text-Villo-primary hover:scale-125" />
                </a>
              </div>
            </div>
            <div className="flex flex-row items-center justify-center m-4">
